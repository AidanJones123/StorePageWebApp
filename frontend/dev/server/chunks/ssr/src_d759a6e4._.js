...
"[project]/src/app/admin/new-game/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ADD_GAME = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$tag$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gql"]`
  mutation AddGame(
    $title: String!
    $platform: String!
    $description: String
...
function NewGamePage() {
    ...
    async function submitForm(e) {
        ...
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apollo$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"].mutate({
                mutation: ADD_GAME,
                variables: form
            });
            if (data) {
...
//# sourceMappingURL=src_d759a6e4._.js.map